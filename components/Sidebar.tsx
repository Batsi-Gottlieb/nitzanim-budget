...
export function Sidebar({
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 shrink-0 flex-col justify-between overflow-y-auto border-l border-sidebar-border bg-sidebar-bg px-4 py-6 text-sidebar-foreground">
      <div>
